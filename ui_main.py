...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.yes_btn.setGeometry(QtCore.QRect(10, 108, 201, 51))
        ...
        self.no_btn.setGeometry(QtCore.QRect(220, 108, 201, 51))
        font = QtGui.QFont()
        font.setPointSize(20)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.reset_btn.setGeometry(QtCore.QRect(90, 250, 71, 31))
        self.reset_btn.setObjectName("reset_btn")
        self.no_lbl = QtWidgets.QLabel(parent=Form)
        self.no_lbl.setGeometry(QtCore.QRect(220, 168, 201, 41))
        font = QtGui.QFont()
        ...
        self.yes_lbl.setGeometry(QtCore.QRect(10, 168, 201, 41))
        font = QtGui.QFont()
        font.setPointSize(16)
        ...
        self.ok_btn.setGeometry(QtCore.QRect(390, 10, 31, 31))
        self.ok_btn.setObjectName("ok_btn")
        self.safe_btn = QtWidgets.QPushButton(parent=Form)
        self.safe_btn.setGeometry(QtCore.QRect(10, 250, 71, 31))
        self.safe_btn.setObjectName("safe_btn")
        self.lcd = QtWidgets.QLCDNumber(parent=Form)
        self.lcd.setGeometry(QtCore.QRect(353, 250, 71, 31))
        self.lcd.setObjectName("lcd")
        self.comboBox = QtWidgets.QComboBox(parent=Form)
        self.comboBox.setGeometry(QtCore.QRect(10, 80, 411, 22))
        self.comboBox.setObjectName("comboBox")
        self.down_btn = QtWidgets.QPushButton(parent=Form)
        self.down_btn.setGeometry(QtCore.QRect(310, 250, 31, 31))
        font = QtGui.QFont()
        font.setPointSize(18)
        self.down_btn.setFont(font)
        self.down_btn.setObjectName("down_btn")
        self.up_btn = QtWidgets.QPushButton(parent=Form)
        self.up_btn.setGeometry(QtCore.QRect(270, 250, 31, 31))
        font = QtGui.QFont()
        font.setPointSize(18)
